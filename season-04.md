...
متدهای <span class="en-text">clean\_\<field_name\>()</span> برای اعتبارسنجی فیلدهای خاص در فرم‌ها استفاده می‌شوند(یعنی برای اعتبارسنجی هر فیلد از یک متد <span class="en-text">clean\_\<field_name\>()</span> استفاده میکنیم | هرفیلد جداگانه اعتبارسنجی میشود).

**نکته:** \<fieldname\> باید با نام فیلد در فرم مطابقت داشته باشد.

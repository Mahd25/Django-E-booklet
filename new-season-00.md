...
#### نوع شبکه از نظر معماری <a id="نوع-شبکه-از-نظر-معماری"></a>
...
#### انواع توپولوژی شبکه <a id="انواع-توپولوژی-شبکه"></a>
...
#### نوع‌های شبکه‌های ارتباطی <a id="نوع‌های-شبکه‌های-ارتباطی"></a>
...
#### انواع پسوند دامنه (Domain Extensions) <a id="انواع-پسوند-دامنه-(Domain-Extensions)"></a>
...
#### جدول شماره پورت‌های مهم <a id="جدول-شماره-پورت‌های-مهم"></a>
...
#### سرور (Server) <a id="سرور-(Server)"></a>
...
#### لوکال هاست (Localhost) <a id="لوکال-هاست-(Localhost)"></a>
...
#### دیتاسنتر (Data Center) <a id="دیتاسنتر-(Data-Center)"></a>
...
### 12. مفهوم وب <a id="12.-مفهوم-وب"></a>
...
#### Web 1.0 (1990-2005) <a id="Web-1.0-(1990-2005)"></a>
...
#### Web 2.0 (از 2006) <a id="Web-2.0-(از-2006)"></a>
...
#### Web 3.0 (در حال ظهور) <a id="Web-3.0-(در-حال-ظهور)"></a>
...
#### Request (درخواست) <a id="Request-(درخواست)"></a>
...
##### Request-Line <a id="Request-Line"></a>
...
##### A Blank Line <a id="A-Blank-Line"></a>
...
#### Structure of Requests <a id="Structure-of-Requests"></a>
...
#### Response (پاسخ) <a id="Response-(پاسخ)"></a>
...
##### Status-Line <a id="Status-Line"></a>
...
#### Structure of Responses <a id="Structure-of-Responses"></a>
...
#### 1xx (Informational) <a id="1xx-(Informational)"></a>

- اطلاعاتی که نشان‌دهنده ادامه پردازش درخواست است.

#### 2xx (Success) <a id="2xx-(Success)"></a>
...
#### 3xx (Redirection) <a id="3xx-(Redirection)"></a>
...
#### 4xx (Client Error) <a id="4xx-(Client-Error)"></a>
...
#### 5xx (Server Error) <a id="5xx-(Server-Error)"></a>
...
#### کوکی‌ها (Cookies) <a id="کوکی‌ها-(Cookies)"></a>
...
#### سشن‌ها (Sessions) <a id="سشن‌ها-(Sessions)"></a>
...
#### مقایسه کوکی‌ها و سشن‌ها <a id="مقایسه-کوکی‌ها-و-سشن‌ها"></a>
...
#### ترکیب کوکی‌ها و سشن‌ها <a id="ترکیب-کوکی‌ها-و-سشن‌ها"></a>
...
#### فرانت‌اند (Front-End) <a id="فرانت‌اند-(Front-End)"></a>
...
#### بک‌اند (Back-End) <a id="بک‌اند-(Back-End)"></a>
...
#### ویژگی‌های کلیدی جنگو <a id="ویژگی‌های-کلیدی-جنگو"></a>
...
#### کاربردهای جنگو <a id="کاربردهای-جنگو"></a>
...
#### نمونه‌هایی از پروژه‌های معروف با جنگو <a id="نمونه‌هایی-از-پروژه‌های-معروف-با-جنگو"></a>
